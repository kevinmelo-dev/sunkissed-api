...
use Src\Catalog\Infrastructure\Http\DeleteProductColorImageController;
use Src\Catalog\Infrastructure\Http\GetProductController;
use Src\Catalog\Infrastructure\Http\GetPublicProductController;
use Src\Catalog\Infrastructure\Http\ListCategoriesController;
use Src\Catalog\Infrastructure\Http\ListColorsController;
use Src\Catalog\Infrastructure\Http\ListProductColorImagesController;
use Src\Catalog\Infrastructure\Http\ListProductsController;
use Src\Catalog\Infrastructure\Http\ListPublicProductsController;
...
use Src\Catalog\Infrastructure\Http\ReorderProductColorImagesController;
use Src\Catalog\Infrastructure\Http\SetProductCoverColorController;
...
use Src\Catalog\Infrastructure\Http\UploadProductColorImageController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::prefix('catalog')->group(function (): void {
        Route::get('products', ListPublicProductsController::class);
        Route::get('products/{slug}', GetPublicProductController::class);
    });
    ...
    Route::prefix('admin')->group(function (): void {
        ...
        Route::middleware('auth:admin')->group(function (): void {
            Route::prefix('catalog')->group(function (): void {
                ...
                Route::put('products/{id}/cover-color', SetProductCoverColorController::class);

                // Product color image management
                Route::post('products/{id}/colors/{colorId}/images', UploadProductColorImageController::class);
                Route::get('products/{id}/images', ListProductColorImagesController::class);
                Route::put('products/{id}/colors/{colorId}/images/order', ReorderProductColorImagesController::class);
                Route::delete('products/{id}/images/{imageId}', DeleteProductColorImageController::class);
